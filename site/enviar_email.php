<HTML>
    <head>
        <meta charset="UTF-8">
        <title>Enviar e-mails TCC</title>
    ...
    require './lib/vendor/autoload.php';
        ...
        try {
            ...
            $mail->setFrom('hellostock.tcc@gmail.com', 'Compras'); //o e-mail que irá enviar, o nome do usuario do e-mail
            ...
            $mail->Body = nl2br($mensagem); // Texto que será colocado no index.html pelo metodo POST
            $mail->AltBody = nl2br(strip_tags($mensagem));  // Texto que será colocado no index.html pelo metodo POST
