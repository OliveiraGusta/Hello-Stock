...
--
-- Host: 127.0.0.1
-- Tempo de geração: 05-Fev-2022 às 02:55
...
CREATE TABLE `cliente` (
  ...
  `contato` varchar(95) DEFAULT NULL,
...
--
ALTER TABLE `cliente`
  MODIFY `cod` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `produto`
  MODIFY `pro_cod` int(15) NOT NULL AUTO_INCREMENT;
...
('root', '[{\"db\":\"hello_stock\",\"table\":\"cliente\"}]');
...
('root', '2022-02-05 01:54:20', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"pt\"}');
